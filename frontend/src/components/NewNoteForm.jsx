...
const NewNoteForm = ({ onNoteCreated, urlOptions, prefilledUrl }) => {
  ...
  return (
    <div>
      <h1 style={{ fontFamily: serifFont, fontWeight: 500, marginBottom: '24px', fontSize: '24px', color: textColor }}>
        Create a new note
      </h1>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: '20px' }}>
          <label
            htmlFor="url"
            style={{ display: 'block', marginBottom: '6px', fontFamily: serifFont, fontSize: '20px', color: textColor }}
          >
            Link
          </label>
          <input
      ...
      {message && (
        <p style={{ fontFamily: serifFont, color: message.includes('Failed') ? '#cc0000' : textColor, marginTop: '12px' }}>
          {message}
        </p>
      )}
    </div>
