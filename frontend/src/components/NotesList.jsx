...
const NotesList = () => {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto', padding: '0 16px' }}>
      ...
      {/* Tabs */}
      <div style={{ display: 'flex', gap: '24px', borderBottom: '1px solid #ccc', marginBottom: '0' }}>
        {['all', 'following'].map(tab => (
          <button
            ...
            style={{
              ...
              fontSize: '16px',
              color: activeTab === tab ? theme.palette.text.primary : theme.palette.text.secondary,
              padding: '8px 0',
              borderBottom: activeTab === tab ? `2px solid ${theme.palette.text.primary}` : '2px solid transparent',
              marginBottom: '-1px',
